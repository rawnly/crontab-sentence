// Icons from https://iconic.app/


export const SunIcon = () => (
	<svg className='w-5' width="24" height="24" fill="none" viewBox="0 0 24 24">
...
export const CopyIcon = () => (
	<svg width="24" height="24" fill="none" viewBox="0 0 24 24" className='w-5'>
